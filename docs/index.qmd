...
Live at [ellmer-practice.ethandbard.com](https://ellmer-practice.ethandbard.com), behind Cloudflare Access on Ethan's own API key, and listed on [ethandbard.com](https://ethandbard.com). Everyone else runs it locally with their own key — see the [README](https://github.com/ethandbard/ellmer-practice#readme).
